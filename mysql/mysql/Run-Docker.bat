call c:\mysql\Init-Container.bat
...
PowerShell Install-MySql -User %userid% -Password %userpwd% -InstallerUrl %installpath% -Port %svcport% -ServiceName %svcname%
...
call PowerShell c:\mysql\wait-service.ps1 -ServiceName %svcname%
